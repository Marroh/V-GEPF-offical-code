...
critic_path = "light_malib/offline_model/entro2_2_1/3/5.0/critic_reward_5.0.pth"
q_path = "light_malib/offline_model/entro2_2_1/3/5.0/Q_reward_5.0.pth"
...
class Backbone(nn.Module):
    ...
    def forward(
        ...
        values, obs_rep, obs = self.encoder(states, observations)
